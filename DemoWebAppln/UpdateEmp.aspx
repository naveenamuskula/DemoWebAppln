<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster1.Master" AutoEventWireup="true" CodeBehind="UpdateEmp.aspx.cs" Inherits="DemoWebAppln.UpdateEmp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>  
            <td>
                <asp:Button ID="btnsubmit" runat="server" Text="submit" OnClick="btnlogin_Click" OnClientClick="return Validate();"/>
            </td>
